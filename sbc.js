...
// to start search when search button is pressed
...
// to start search when enter key is pressed
...
async function fetchVideo(queryitem) {
    ...
    for (let i = 0; i < res1.items.length; i++) {
        ...
        <div class="card-body">
          ...
          <a href="https://www.youtube.com/results?search_query=${res1.items[i].id.channelId}" class="btn btn-outline-dark col-xl-5 p-1"><i class="fas fa-eye"></i> View Page </a>
